...
let g:NERDTreeIgnore=['^xunit.xml$', '^.coverage$', '^selenium-debug.log$', '^npm-debug.log$', '^tags$', 'pyc$', '.git$[[dir]]', '.cache[[dir]]', '.egg-info[[dir]]', '.tox[[dir]]', '.ropeproject[[dir]]', '.publish[[dir]]', '_site[[dir]]', '.sass-cache[[dir]]', '.vagrant[[dir]]', '__pycache__[[dir]]', 'venv[[dir]]', '.nyc_output[[dir]]']
