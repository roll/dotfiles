...
hi SignColumn guifg=#A6E22E guibg=#232526 guisp=#232526 gui=NONE ctermfg=106 ctermbg=236 cterm=NONE
...
hi NonText guifg=#BCBCBC guibg=#3B3A32 guisp=#3B3A32 gui=NONE ctermfg=240 ctermbg=236 cterm=NONE
...
hi LineNr guifg=#BCBCBC guibg=#3B3A32 guisp=#3B3A32 gui=NONE ctermfg=240 ctermbg=236 cterm=NONE
hi StatusLine guifg=#455354 guibg=#F8F8F2 guisp=#F8F8F2 gui=NONE ctermfg=240 ctermbg=230 cterm=NONE
hi Normal guifg=#e4e4e4 guibg=#303030 guisp=#303030 gui=NONE ctermfg=253 ctermbg=236 cterm=NONE
...
hi FoldColumn guifg=#465457 guibg=#000000 guisp=#000000 gui=NONE ctermfg=240 ctermbg=236 cterm=NONE
...
hi VertSplit guifg=#808080 guibg=#080808 guisp=#080808 gui=bold ctermfg=240 ctermbg=236 cterm=NONE
...
hi MatchParen guifg=#000000 guibg=#FD971F guisp=#FD971F gui=bold ctermfg=208 ctermbg=236 cterm=bold
...
hi CoffeeSpecialVar ctermfg=106 ctermbg=236
